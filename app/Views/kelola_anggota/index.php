...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800"> <i class="fas fa-user"></i> Data Anggota</h1>
                ...
                <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                    <thead style="background-color: #FFE7AD;">
                        <tr>
                            ...
                            <th class="text-center text-dark">Penanggung Jawab</th>
                            <th class="text-center text-dark">Aksi</th>

                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($anggota as $key => $value) : ?> <!-- ambil dari anggotaController.php -->
                            <tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-plus"></i><b> Tambah Anggota</b></h5>
            ...
            <form action="<?= site_url('kelola-anggota') ?>" method="post" autocomplete="off">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"></i> <b>Data Anggota</b></h5>
                </div>
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"></i> <b>Koperasi Anggota</b></h5>
                </div>
                <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <label for="recipient-name" class="col-form-label">Unit/UP/Cabang</label>
                        <select class="input-large form-control" name="status_perkawinan" required>
                            <option value="" readonly="">Pilih Unit/UP/Cabang</option>
                            <option value="0">Null</option>
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"></i> <b>Akun Anggota</b></h5>
                </div>
                <div class="modal-body">
...
<?php foreach ($anggota as $key => $value) : ?> <!-- ambil dari anggotaController.php -->
    ...
    <div class="modal fade" id="editModal<?php echo $value->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-user"></i><b>   Profil Anggota </b></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="modal-body">    
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <label for="recipient-name" class="col-form-label text"><b>Nama Anggota</b></label>
                                            <h4>----</h4>
                                            <label for="recipient-name" class="col-form-label"><b>No ID Anggota</b></label>
                        ...
                        <div class="row">
                            ...
                            <form action="<?= site_url('kelola-anggota/' . $value->id) ?>" method="post" autocomplete="off">

                                <div class="modal-body">    
                                    <h4><b>Data Anggota</b></h4><br>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <label for="recipient-name" class="col-form-label">Unit/UP/Cabang</label><br>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="recipient-name" class="col-form-label"><b>----</b></label><br>
                                            <label for="recipient-name" class="col-form-label"><b>----</b></label><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="recipient-name" class="col-form-label">Jumlah Pinjaman</label><br>
                                            <label for="recipient-name" class="col-form-label">Pinjaman Lunas</label><br>
                                            <label for="recipient-name" class="col-form-label">Pembayaran</label><br>
                                            <label for="recipient-name" class="col-form-label">Tanggal Tempo</label><br>
                                        </div>
                                        <div class="col-md-6">
