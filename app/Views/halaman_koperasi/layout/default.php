...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3 text-dark"><img class="" width="30px" src="<?= base_url() ?>/image-removebg-preview.png"> SILAKKOP</div>
            </a>
            ...
            <?= $this->include('halaman_koperasi/layout/menu') ?> <!-- INI UNTUK PANGGIL MENU -->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><b><?= session('nama_pengguna') ?></b> <i class="text-danger">(Koperasi)</i></span>
                                <img class="" width="50px" src="<?= base_url() ?>/ava.png">
                            </a>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Klik "Logout" di bawah ini jika anda ingin logout</div>
    ...
    const ctx = document.getElementById('myChart');
        ...
        new Chart(ctx, {
            ...
            datasets: [{
                ...
                data: [12, 19, 3, 5, 2, 3, 2, 4, 5, 4, 3, 2],
                borderWidth: 1
            }   ]
            },
            options: {
    ...
    <script>
        ...
        $('input[name="foto_profil"]').change(function(e) {
